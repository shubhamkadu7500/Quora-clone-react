        ...
        <div className="login-auth">
          <div className="login-option1">
            <div className="login-desc">
                <p>By continuing you indicate thst you agree to <br />Quora <span className="term">Terms of Service</span> and <span className="term">Privacy Policy</span></p>
            </div>

            <div className="login-option">
              <div className="opt1">
                <img src="/images/google-icon.svg" alt="goole-logo" />
                <a  href="#" >Conitnue with Google</a>
              </div>
